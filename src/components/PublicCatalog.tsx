...
const PublicCatalog: React.FC<PublicCatalogProps> = ({ products, onAdminAccess }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-medium rounded-lg hover:from-gray-700 hover:to-gray-800 transition-all duration-200 shadow-md hover:shadow-lg"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">
              Sistema de catálogo de productos de belleza con gestión administrativa
            </p>
            <div className="mt-4 text-xs text-gray-500">
              <p>© 2025 Beauty Catalog. Desarrollado para gestión profesional de productos de belleza.</p>
            </div>
          </div>
        </div>
      </footer>
